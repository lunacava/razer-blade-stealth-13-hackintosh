 ...
 *
 * Disassembly of SSDB-OptRef-OptTabl-00001000.aml
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001F0D (7949)
 *     Revision         0x01
 *     Checksum         0xCA
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.ECE1, UnknownObj)
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        Name (GPRF, Zero)
        OperationRegion (NVHM, SystemMemory, NVHA, 0x00040400)
        ...
        Method (_ROM, 2, NotSerialized)  // _ROM: Read-Only Memory
        {
            ...
            {
                Local0 -= 0x00030000
                ROM1 = RBF7 /* \_SB_.PCI0.RP05.PEGP.RBF7 */
            }
            ElseIf ((Local0 < 0x00040000))
            {
                Local0 -= 0x00038000
                ROM1 = RBF8 /* \_SB_.PCI0.RP05.PEGP.RBF8 */
            }
    ...
    Scope (\_SB.PCI0.RP05.PEGP)
    {
        ...
        {
            Debug = "<<< GC6I >>>"
            \_SB.PCI0.LTRE = \_SB.PCI0.LREN /* External reference */
            \_SB.PCI0.LKDN = One
            While ((\_SB.GGIV (0x04070014) != One))
            {
                Sleep (One)
            }
        }
        ...
        Method (GC6O, 0, Serialized)
        {
            Debug = "<<< GC6O >>>"
            \_SB.PCI0.LKDN = Zero
            If ((\_SB.GGIV (0x04070014) == One))
            {
                \_SB.PCI0.SGPO (Zero, 0x04070017, Zero, One)
                While ((\_SB.GGIV (0x04070014) != Zero))
                {
                    Sleep (One)
                }

                \_SB.PCI0.SGPO (Zero, 0x04070017, Zero, Zero)
            }
            ...
            \_SB.PCI0.LREN = \_SB.PCI0.LTRE /* External reference */
            \_SB.PCI0.CEDN = One
        }

        Method (GETS, 0, Serialized)
        {
            If ((\_SB.GGIV (0x04070014) == Zero))
            {
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x22)
                {
                    ...
                    If ((PCAP < \_SB.PCI0.LPCB.EC0.ECE1))
                    {
                        PCAP = \_SB.PCI0.LPCB.EC0.ECE1 /* External reference */
                    }
                    ...
                    Switch (PSH0)
                    {
                        Case (Zero)
                        {
                            If (CPUT)
                            {
                                ...
                                PDTS = \_SB.PCI0.LPCB.H_EC.LTMP /* External reference */
                            }
